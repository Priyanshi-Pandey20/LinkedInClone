...
import { acceptConnectionRequest, downloadProfile, getAllUserProfile, getMyConnectionRequest, getUserAndProfile, getUserProfileAndUserBasedOnUsername, login, register,sendConnectionRequest,updateProfileData,updateUserProfile,uploadProfilePicture, whatAreMyConections } from "../controllers/user.controller.js";
...
router.get("/user/getConnectionRequests",getMyConnectionRequest);
router.get("/user/user_connection_request", whatAreMyConections);
